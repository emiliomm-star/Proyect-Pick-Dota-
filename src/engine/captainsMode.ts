...
export function initialCaptainsState(): CaptainsState {
  return { radiantPicks: [], direPicks: [], radiantBans: [], direBans: [], stepIndex: 0 };
}
 ...
 */
export function applyChoice(state: CaptainsState, heroId: number): CaptainsState {
